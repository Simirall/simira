...
export default async function RootLayout({ children }: RootLayoutProps) {
  return (
    <div className="h-svh bg-radial-[at_25%_25%] from-sky-50 via-sky-100 to-sky-200 p-4 [view-transition-name:page] sm:p-12 dark:from-cyan-900 dark:via-sky-950 dark:to-gray-900">
